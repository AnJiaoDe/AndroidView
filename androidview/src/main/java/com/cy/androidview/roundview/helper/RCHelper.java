...
package com.cy.androidview.roundview.helper;
...
public class RCHelper {
    ...
    public void initAttrs(Context context, TypedArray typedArray) {
        mRoundAsCircle = typedArray.getBoolean(R.styleable.AttrsRound_cy_round_as_circle, false);
        mStrokeColorStateList = typedArray.getColorStateList(R.styleable.AttrsRound_cy_stroke_color);
        ...
        mStrokeWidth = typedArray.getDimensionPixelSize(R.styleable.AttrsRound_cy_stroke_width, 0);
        mClipBackground = typedArray.getBoolean(R.styleable.AttrsRound_cy_clip_background, true);
        int roundCorner = typedArray.getDimensionPixelSize(R.styleable.AttrsRound_cy_radiusCorner, 0);
        int roundCornerTopLeft = typedArray.getDimensionPixelSize(
                R.styleable.AttrsRound_cy_radiusTopLeft, roundCorner);
        int roundCornerTopRight = typedArray.getDimensionPixelSize(
                R.styleable.AttrsRound_cy_radiusTopRight, roundCorner);
        int roundCornerBottomLeft = typedArray.getDimensionPixelSize(
                R.styleable.AttrsRound_cy_radiusBottomLeft, roundCorner);
        int roundCornerBottomRight = typedArray.getDimensionPixelSize(
                R.styleable.AttrsRound_cy_radiusBottomRight, roundCorner);

...
public class RelativeLayoutRound extends RelativeLayout implements Checkable, RCAttrs, IRectangle, IRipple {
    RCHelper mRCHelper;
    ...
    public RelativeLayoutRound(Context context, AttributeSet attrs, int defStyleAttr) {

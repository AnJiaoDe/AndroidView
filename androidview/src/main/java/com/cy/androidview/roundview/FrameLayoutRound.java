...
public class FrameLayoutRound extends FrameLayout implements Checkable, RCAttrs, IRectangle, IRipple {
    RCHelper mRCHelper;
    ...
    public FrameLayoutRound(Context context, AttributeSet attrs, int defStyleAttr) {

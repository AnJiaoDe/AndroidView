...
public class LinearLayoutRound extends LinearLayout implements Checkable, RCAttrs, IRectangle, IRipple {
    RCHelper mRCHelper;
    ...
    public LinearLayoutRound(Context context, AttributeSet attrs, int defStyleAttr) {

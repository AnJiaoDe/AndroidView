...
public class ButtonRound extends AppCompatButton implements Checkable, RCAttrs , IRectangle, IRipple {
    ...
    public ButtonRound(Context context, AttributeSet attrs, int defStyleAttr) {

...
public class LinearLayoutCard extends LinearLayout implements IRectangle {
    ...
    public LinearLayoutCard(@NonNull Context context) {
        this(context, null);
    }

    public LinearLayoutCard(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, R.attr.cardViewStyle);
    }

    public LinearLayoutCard(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private final CardViewDelegate mCardViewDelegate = new CardViewDelegate() {
        ...
        @Override
        public boolean getUseCompatPadding() {
            return LinearLayoutCard.this.getUseCompatPadding();
        }

        @Override
        public boolean getPreventCornerOverlap() {
            return LinearLayoutCard.this.getPreventCornerOverlap();
        }

        @Override
        public void setShadowPadding(int left, int top, int right, int bottom) {
            mShadowBounds.set(left, top, right, bottom);
            LinearLayoutCard.super.setPadding(left + mContentPadding.left, top + mContentPadding.top,
        ...
        public void setMinWidthHeightInternal(int width, int height) {
            if (width > mUserSetMinWidth) {
                LinearLayoutCard.super.setMinimumWidth(width);
            }
            if (height > mUserSetMinHeight) {
                LinearLayoutCard.super.setMinimumHeight(height);
            }
        }

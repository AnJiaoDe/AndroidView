...
public class ImageViewCard extends AppCompatImageView implements IRectangle {
    ...
    public ImageViewCard(@NonNull Context context) {
        this(context, null);
    }
    ...
    private final CardViewDelegate mCardViewDelegate = new CardViewDelegate() {
        ...
        @Override
        public boolean getUseCompatPadding() {
            return ImageViewCard.this.getUseCompatPadding();
        }

        @Override
        public boolean getPreventCornerOverlap() {
            return ImageViewCard.this.getPreventCornerOverlap();
        }

        @Override
        public void setShadowPadding(int left, int top, int right, int bottom) {
            mShadowBounds.set(left, top, right, bottom);
            ImageViewCard.super.setPadding(left + mContentPadding.left, top + mContentPadding.top,
        ...
        public void setMinWidthHeightInternal(int width, int height) {
            if (width > mUserSetMinWidth) {
                ImageViewCard.super.setMinimumWidth(width);
            }
            if (height > mUserSetMinHeight) {
                ImageViewCard.super.setMinimumHeight(height);
            }
        }

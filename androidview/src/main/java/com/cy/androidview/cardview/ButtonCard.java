...
public class ButtonCard extends AppCompatButton implements IRectangle {
    ...
    public ButtonCard(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, R.attr.cardViewStyle);
    }

    public ButtonCard(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private final CardViewDelegate mCardViewDelegate = new CardViewDelegate() {
        ...
        public void setShadowPadding(int left, int top, int right, int bottom) {
            ...
            ButtonCard.super.setPadding(left + mContentPadding.left, top + mContentPadding.top,
        ...
        public void setMinWidthHeightInternal(int width, int height) {
            if (width > mUserSetMinWidth) {
                ButtonCard.super.setMinimumWidth(width);
            }
            if (height > mUserSetMinHeight) {
                ButtonCard.super.setMinimumHeight(height);
            }
        }

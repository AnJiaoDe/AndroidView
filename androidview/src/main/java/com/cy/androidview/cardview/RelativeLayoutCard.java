...
public class RelativeLayoutCard extends RelativeLayout implements IRectangle {
    ...
    public RelativeLayoutCard(@NonNull Context context) {
        this(context, null);
    }

    public RelativeLayoutCard(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, R.attr.cardViewStyle);
    }

    public RelativeLayoutCard(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private final CardViewDelegate mCardViewDelegate = new CardViewDelegate() {
        ...
        @Override
        public boolean getUseCompatPadding() {
            return RelativeLayoutCard.this.getUseCompatPadding();
        }

        @Override
        public boolean getPreventCornerOverlap() {
            return RelativeLayoutCard.this.getPreventCornerOverlap();
        }

        @Override
        public void setShadowPadding(int left, int top, int right, int bottom) {
            mShadowBounds.set(left, top, right, bottom);
            RelativeLayoutCard.super.setPadding(left + mContentPadding.left, top + mContentPadding.top,
        ...
        public void setMinWidthHeightInternal(int width, int height) {
            if (width > mUserSetMinWidth) {
                RelativeLayoutCard.super.setMinimumWidth(width);
            }
            if (height > mUserSetMinHeight) {
                RelativeLayoutCard.super.setMinimumHeight(height);
            }
        }
        ...
        public View getCardView() {
            return RelativeLayoutCard.this;
        }
    };

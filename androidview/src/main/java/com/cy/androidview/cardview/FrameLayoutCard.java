...
public class FrameLayoutCard extends FrameLayout implements IRectangle {
    ...
    public FrameLayoutCard(@NonNull Context context) {
        this(context, null);
    }

    public FrameLayoutCard(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, R.attr.cardViewStyle);
    }

    public FrameLayoutCard(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private final CardViewDelegate mCardViewDelegate = new CardViewDelegate() {
        ...
        @Override
        public boolean getUseCompatPadding() {
            return FrameLayoutCard.this.getUseCompatPadding();
        }

        @Override
        public boolean getPreventCornerOverlap() {
            return FrameLayoutCard.this.getPreventCornerOverlap();
        }

        @Override
        public void setShadowPadding(int left, int top, int right, int bottom) {
            mShadowBounds.set(left, top, right, bottom);
            FrameLayoutCard.super.setPadding(left + mContentPadding.left, top + mContentPadding.top,
        ...
        public void setMinWidthHeightInternal(int width, int height) {
            if (width > mUserSetMinWidth) {
                FrameLayoutCard.super.setMinimumWidth(width);
            }
            if (height > mUserSetMinHeight) {
                FrameLayoutCard.super.setMinimumHeight(height);
            }
        }

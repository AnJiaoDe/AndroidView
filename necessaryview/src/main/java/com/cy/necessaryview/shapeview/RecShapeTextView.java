...
public class RecShapeTextView extends TextView {
    ...
    public RecShapeTextView(Context context, AttributeSet attrs) {
        ...
        baseOnWidthOrHeight = arr.getBoolean(R.styleable.RecShapeTextView_baseOnWidthOrHeight, true);
        ...
        boolean havaRipple = arr.getBoolean(R.styleable.RecShapeTextView_haveRipple, true);//设置是否有水波纹点击效果，默认有
